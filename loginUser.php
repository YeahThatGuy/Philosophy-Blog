...
<body>
	...
	<div class="container organiseForm">
		<form id="newUsers" action="login.php" method="post">
			<fieldset>
				...
				<div class="center_div">
					<button type="submit" id="subLogin" name="login" class="btn btn-primary">Submit</button>
				</div>
	...
	<!-- After the user presses submit
		...
		If username == username from MySQL then create a session
		Session needs to carry across all pages until user presses logout -->
