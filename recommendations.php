	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				$sql="SELECT postId, postTitle, postText, userID, postThumbnail, postCategory, personID, username, new_date FROM posts, users WHERE userID = personID AND postCategory = 'Recommendation' ORDER BY postId DESC";
